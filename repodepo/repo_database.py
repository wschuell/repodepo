...
class Database(object):
	...
	def clean_db(self,sqlite_del=True):
		...
		if self.db_type == 'sqlite' and not self.in_ram and sqlite_del:
			...
			self.cursor.execute('DROP TABLE IF EXISTS issues_comments CASCADE;')
			self.cursor.execute('DROP TABLE IF EXISTS issues_reactions CASCADE;')
			self.cursor.execute('DROP TABLE IF EXISTS issues_labels CASCADE;')
			self.cursor.execute('DROP TABLE IF EXISTS issues CASCADE;')
			self.cursor.execute('DROP TABLE IF EXISTS pullrequests_comment_reactions CASCADE;')
			self.cursor.execute('DROP TABLE IF EXISTS pullrequests_comments CASCADE;')
			self.cursor.execute('DROP TABLE IF EXISTS pullrequests_reactions CASCADE;')
			self.cursor.execute('DROP TABLE IF EXISTS pullrequests_labels CASCADE;')
