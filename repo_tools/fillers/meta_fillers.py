...
class DummyMetaFiller(fillers.Filler):
	...
	def prepare(self):
		...
		self.db.add_filler(github_gql.LanguagesGQLFiller(fail_on_wait=self.fail_on_wait,workers=self.workers,data_folder=data_folder,api_keys_file=api_keys_file))
